...
export function ColorRow( {
	...
	return (
		<div className="socialframe-color-row">
			...
			{ ( themeColors ?? [] ).map( ( { color, name, slug } ) => (
				<button
					...
					className={ `socialframe-color-swatch${
						value === color
							? ' socialframe-color-swatch--active'
							: ''
					}` }
			...
			{ showNone && (
				<button
					className={ `socialframe-color-swatch socialframe-color-swatch--none${
						isNoneActive ? ' socialframe-color-swatch--active' : ''
					}` }
