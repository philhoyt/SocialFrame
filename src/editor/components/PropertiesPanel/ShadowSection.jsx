		...
		<>
			<button
				className={ `socialframe-props__toggle-btn${
					hasShadow ? ' socialframe-props__toggle-btn--active' : ''
				}` }
			...
			>
				{ hasShadow
					? __( 'Shadow On', 'socialframe' )
					: __( 'Shadow Off', 'socialframe' ) }
			</button>

			{ hasShadow && (
				<>
					<div
						className="socialframe-props__subsection-label"
						style={ { marginTop: 4 } }
					>
					...
					>
						...
						<LinkedNumFields
							...
							onChangeBoth={ ( x, y ) =>
								applyShadow( { offsetX: x, offsetY: y } )
							}
						/>
					</div>
				</>
