...
const ALIGNMENTS = [
	{ id: 'left',    icon: <IconAlignLeft />,    label: __( 'Align left',        'socialframe' ) },
	{ id: 'centerH', icon: <IconAlignCenterH />, label: __( 'Center horizontal', 'socialframe' ) },
	{ id: 'right',   icon: <IconAlignRight />,   label: __( 'Align right',       'socialframe' ) },
	{ id: 'top',     icon: <IconAlignTop />,     label: __( 'Align top',         'socialframe' ) },
	{ id: 'centerV', icon: <IconAlignCenterV />, label: __( 'Center vertical',   'socialframe' ) },
	{ id: 'bottom',  icon: <IconAlignBottom />,  label: __( 'Align bottom',      'socialframe' ) },
];
