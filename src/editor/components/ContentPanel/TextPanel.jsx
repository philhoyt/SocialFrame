...
const TEXT_ROLES = [
	{
		role: 'huge',
		label: __( 'Huge', 'socialframe' ),
		style: { fontSize: 28, fontWeight: 'bold' },
	},
	{
		role: 'extra-large',
		label: __( 'Extra Large', 'socialframe' ),
		style: { fontSize: 22 },
	},
	{
		role: 'large',
		label: __( 'Large', 'socialframe' ),
		style: { fontSize: 17 },
	},
	{
		role: 'medium',
		label: __( 'Medium', 'socialframe' ),
		style: { fontSize: 13 },
	},
	{
		role: 'small',
		label: __( 'Small', 'socialframe' ),
		style: { fontSize: 11 },
	},
];
